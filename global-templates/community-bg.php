...
<div id="kids">
  <div class="hero--bg-image" style="background-image: 
    linear-gradient(rgba(37, 51, 102, 0.6), rgba(37, 51, 102, 0.6)), url('<?php the_field('community_bg'); ?>');">
    <div class="container text-center quote-h text-light">
      <h2 class="display-4"><?php the_field('community_text'); ?></h2>
